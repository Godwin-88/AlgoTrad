...
class Backtest:
    ...
    def __init__(
        self, csv_dir: str, symbol_list: List[str], initial_capital: float,
        heartbeat: float, start_date: datetime.datetime, data_handler: Type,
        execution_handler: Type, portfolio: Type, strategy: Type
    ):
        """
